...
func (r *Reporter) GenerateHTML(result *models.AnalysisResult, lang string) string {
	...
	sb.WriteString("<title>Black Hat - Analysis Report</title>\n")
	...
	sb.WriteString("<h1>Black Hat - Analysis Report</h1>\n")
	...
	sb.WriteString("<p>Generated by Black Hat - Code Analysis Platform</p>\n")
